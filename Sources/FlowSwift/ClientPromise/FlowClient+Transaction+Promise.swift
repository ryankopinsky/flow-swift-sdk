...
extension FlowClient {
    ...
    public func sendTransaction(script: String, arguments: [CadenceValue], singleSigner: String, keychain: FlowKeyChainProtocol) -> Promise<FlowIdentifier>{
        ...
        return self.sendTransaction(script: script,
                                    arguments: arguments,
                             proposer: proposer ,
                             payer: proposer,
    ...
    public func sendTransaction(script: String, arguments: [CadenceValue], proposer: FlowAddress, payer: FlowAddress, authorizers: [FlowAddress], keychain: FlowKeyChainProtocol) -> Promise<FlowIdentifier> {
