...
public class FlowEntity : Equatable{
    ...
    public func set(transform: @escaping((Element) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowAddress: FlowBlob{
    ...
    public var hex: String {
        return self.data.bytes.map{String(format:"%02x", $0)}.joined()
    }
    ...
    public init(_ bytes: [UInt8]) throws{
        ...
        _ = self.data.padLeftZero(8)
        guard (self.data.bytes.count<=8) else{
...
public class FlowBlob: FlowEntity, DataProtocol, CustomStringConvertible{
    ...
    public override func set(transform: @escaping((FlowBlob) -> Void)) -> Void {
        transform(self)
    }
    ...
    public init(_ data: Data){
        ...
        self.startIndex = self.data.startIndex
        self.endIndex = self.data.endIndex
    }
...
public class FlowTransactionProposalKey: FlowEntity {
    public override func set(transform: @escaping((FlowTransactionProposalKey) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowTransactionSignature: FlowEntity{
    public override func set(transform: @escaping((FlowTransactionSignature) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowTransaction: FlowEntity {
    public override func set(transform: @escaping((FlowTransaction) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowTransactionResult: FlowEntity{
    public override func set(transform: @escaping((FlowTransactionResult) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowExecutionResult: FlowEntity{
    public override func set(transform: @escaping((FlowExecutionResult) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowChunk: FlowEntity{
    public override func set(transform: @escaping((FlowChunk) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowServiceEvent: FlowEntity{
    public override func set(transform: @escaping((FlowServiceEvent) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowBlockHeader: FlowEntity{
    public override func set(transform: @escaping((FlowBlockHeader) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowBlockSeal: FlowEntity{
    public override func set(transform: @escaping((FlowBlockSeal) -> Void)) -> Void {
        transform(self)
    }
    public var blockId: FlowIdentifier = FlowIdentifier()
...
public class FlowBlock: FlowEntity{
    ...
    public override func set(transform: @escaping((FlowBlock) -> Void)) -> Void {
        transform(self)
    }
    public var id: FlowIdentifier = FlowIdentifier()
    public var parentId: FlowIdentifier = FlowIdentifier()
...
public class FlowCollection: FlowEntity{
    public override func set(transform: @escaping((FlowCollection) -> Void)) -> Void {
        transform(self)
    }
    public var id: FlowIdentifier = FlowIdentifier()
...
public class FlowCollectionGuarantee: FlowEntity{
    public override func set(transform: @escaping((FlowCollectionGuarantee) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowDeployedContract: FlowEntity{
    public override func set(transform: @escaping((FlowDeployedContract) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowEvent: FlowEntity {
    public override func set(transform: @escaping((FlowEvent) -> Void)) -> Void {
        transform(self)
    }
    public var type: String = ""
...
public class FlowEventsResult: FlowEntity {
    public override func set(transform: @escaping((FlowEventsResult) -> Void)) -> Void {
        transform(self)
    }
    public var blockId: FlowIdentifier = FlowIdentifier();
...
public class FlowEventsResponse: FlowEntity {
    public override func set(transform: @escaping((FlowEventsResponse) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowAccountKey: FlowEntity{
    public override func set(transform: @escaping((FlowAccountKey) -> Void)) -> Void {
        transform(self)
    }
...
public class FlowAccount: FlowEntity{
    public override func set(transform: @escaping((FlowAccount) -> Void)) -> Void {
        transform(self)
    }
    public var address: FlowAddress=FlowAddress.from("0x0")!
