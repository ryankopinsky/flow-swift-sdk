...
public class FlowClient: FlowEntity{
    ...
    public func ping(completion: @escaping(ResultCallback)){
        self.rpcProvider.ping(completion: completion)
    }
...
"""
        self.sendTransaction(script: script,
...
"""
        ...
        try! self.sendTransaction(script: script,
...
"""
    ...
    public func removeContractFromAccount(_ account: FlowAddress, contractName: String,   keychain: FlowKeyChainProtocol, index: Int, completion: @escaping(ResultCallback)){
        let script = """
...
"""
    ...
    public func updateContractOfAccount(_ account: FlowAddress, contractName: String, newCode:String,  keychain: FlowKeyChainProtocol, index: Int, completion: @escaping(ResultCallback)){
        let script = """
transaction(name: String, code: String) {
    prepare(signer: AuthAccount) {
